...
impl From<enums::PayoutType> for StripeExternalAccountType {
    fn from(payout_type: enums::PayoutType) -> Self {
        match payout_type {
            enums::PayoutType::Bank => StripeExternalAccountType::BankAccount,
            enums::PayoutType::Card => StripeExternalAccountType::Card,
        }
    }
}
...
impl From<enums::PayoutType> for StripePayoutMethod {
    fn from(payout_type: enums::PayoutType) -> Self {
        match payout_type {
            enums::PayoutType::Bank => StripePayoutMethod::Standard,
            enums::PayoutType::Card => StripePayoutMethod::Instant,
        }
    }
}
